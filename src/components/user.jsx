...
function User({ username, player, computer, results }) {
  return (
    <div className="bg-gradient-to-t bg-primary-500 from-black via-pink-900 to-pink-700  h-72 w-60 rounded-2xl shadow-md relative flex flex-col items-center justify-between md:items-start py-5 md:p-5">
      <img
